                            ...
                            <li class="product type-product post-16 status-publish first instock product_cat-magazine product_tag-structural_varnish has-post-thumbnail shipping-taxable purchasable product-type-simple">
                                <div class="qodef-woo-product-inner">
                                    <div class="qodef-woo-product-image">
                                        <img width="600" height="563" src="<?=\yii\helpers\Url::to(["../shop/wp-content/uploads/2020/05/shop-image2-600x563.jpg"], true)?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="a" srcset="<?=\yii\helpers\Url::to(["../shop/wp-content/uploads/2020/05/shop-image2-600x563.jpg 600w"], true)?>, <?=\yii\helpers\Url::to(["../shop/wp-content/uploads/2020/05/shop-image2-300x281.jpg 300w"], true)?>, <?=\yii\helpers\Url::to(["../shop/wp-content/uploads/2020/05/shop-image2-768x720.jpg 768w"], true)?>, <?=\yii\helpers\Url::to(["../shop/wp-content/uploads/2020/05/shop-image2-768x720.jpg 768w"], true)?>"
                                             sizes="(max-width: 600px) 100vw, 600px" />
                                        <div class="qodef-woo-product-image-inner">
                                            <div class="qodef-woo-product-image-inner-2">
                                                <div class="qodef-woo-product-button-holder"><a href="#" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart qodef-btn-wave-hover" data-product_id="16"
                                                                                                data-product_sku="001" aria-label="Add &ldquo;Catalogs&rdquo; to your cart" rel="nofollow">Add to cart<span class="qodef-btn-masked"><span class="qodef-m-text">Add to cart</span></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="qodef-woo-product-content">
                                        <div class="qodef-woo-product-content-top">
                                            <h6 class="qodef-woo-product-title woocommerce-loop-product__title">Catalogs</h6>
                                            <span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>10.00</span>
                                                    </span>
                                        </div>
                                        <div class="qodef-woo-product-categories"><a href="#" rel="tag">Magazine</a>
                                        </div>
                                    </div>
